...
public class TickData implements Serializable {
    ...
    public TickData( GregorianCalendar dateTime, double open, double high, double low, double close, long volume) {
     ...
     */
    public TickData(GregorianCalendar dateTime, double open, double high, double low, double close, long volume, long openInterest) {
